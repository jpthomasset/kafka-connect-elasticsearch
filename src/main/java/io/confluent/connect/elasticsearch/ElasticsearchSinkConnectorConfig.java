...
public class ElasticsearchSinkConnectorConfig extends AbstractConfig {
  ...
  public static final String UNSET_KEY_CONFIG = "key.unset";
  private static final String UNSET_KEY_DOC =
          "Whether to unset the record key for the purpose of forming the Elasticsearch document "
                  + "Id. When this is set to ``true``, document IDs will be auto-generated by "
                  + "Elasticsearch. Note that this is a global config that applies to all "
                  + "topics.";
  private static final String UNSET_KEY_DISPLAY = "Unset Key mode";
  private static final boolean UNSET_KEY_DEFAULT = false;
  ...
  public boolean unsetKey() {
    return getBoolean(UNSET_KEY_CONFIG);
  }
